 ...
 *
 * What is deliberately NOT here: the bundle identifier, the config directory,
 * the `FERAL_*` environment variables, the `feral://` event channel names and
 * the CLI binary name. Those are technical identities with migration cost, and
 * they move in a later phase with a migrator beside them. See RENAME-PLAN.md.
 */
