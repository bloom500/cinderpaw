...
const en = {
  ...
  'call.providerNone': 'No voice provider is connected, so this call will echo you back. Add a key in Settings → Providers to be answered.',
...
const ro: Strings = {
  ...
  'call.providerNone': 'Niciun furnizor de voce conectat, deci apelul îți va întoarce ecoul. Adaugă o cheie în Setări → Furnizori ca să primești răspuns.',
  'call.liveEngine': 'Gemini Live',
