...
New-Item -ItemType Directory -Force -Path "D:/FeralLocalAI/frontend/graphify-out" | Out-Null
...
$GRAPHIFY_PYTHON | Out-File -FilePath "D:/FeralLocalAI/frontend/graphify-out/.graphify_python" -Encoding utf8 -NoNewline
