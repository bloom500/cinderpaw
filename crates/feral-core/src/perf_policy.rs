...
//! `FeralAgent/src/sandbox/perf-policy.ts` and the frontend
...
impl DeadlineReason {
    /// Stable machine prefix used inside the `feral://stream-error`
...
/// Render the human-readable line carried by `feral://stream-error`
