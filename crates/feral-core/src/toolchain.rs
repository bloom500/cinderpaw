...
/// the portable copy forward when a Feral update bumps this.
...
/// The stamp records which URL produced a portable tool. A Feral update
...
/// WITH Feral releases, never behind the user's back.
