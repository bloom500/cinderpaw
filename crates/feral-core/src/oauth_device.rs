...
//!
//! Why this flow and not the ordinary redirect one: Feral is a desktop app and
...
//! neither: Feral shows a short code, the person types it on the provider's own
//! site, Feral polls until they are done.
//!
