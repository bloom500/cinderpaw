...
const SPOKEN_RULES: &[&str] = &[
    ...
    // challenged, "yes, I'll call Cinderpaw for the configuration, I was just
...
mod tests {
    ...
    fn the_persona_reaches_a_call_before_the_rules_do() {
        ...
        let rules_at = text.find("You are Cinderpaw").expect("rules present");
    ...
    fn a_request_to_search_is_told_to_be_a_tool_call() {
        // Measured 2026-08-15: "search the web for ways to promote Cinderpaw" got an
