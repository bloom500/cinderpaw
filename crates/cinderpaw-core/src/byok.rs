    ...
    pub fn get_all_providers(&self) -> Vec<ProviderInfo> {
        ...
        defaults.into_iter().map(|(id, name, provider)| {
            ...
            ProviderInfo {
                ...
                base_url: config.base_url.or(Some(default_base_url_for(&id))),
...
pub fn provider_catalog() -> Vec<ProviderCatalogEntry> {
    ...
    vec![
        ...
        // The OpenAI-compatible providers from OpenClaw's manifests
        // (scripts/openclaw/openclaw-providers.json, MIT). Each is `Custom`:
        // bearer key, `{base}/chat/completions`, its own base URL. Left out on
        // purpose: GitHub Copilot and Ollama Cloud (other protocols), Meta's
        // direct API (responses only), Bedrock and Vertex (cloud auth), and the
        // "plan" subscription variants, one row per vendor.
        ProviderCatalogEntry {
            id: "baseten".into(),
            name: "Baseten".into(),
            provider: Provider::Custom,
            default_base_url: "https://inference.baseten.co/v1".into(),
            default_model: "thinkingmachines/inkling".into(),
            console_url: None,
            key_format: None,
            key_format_hint: None,
            free_tier_note: None,
        ...
        ProviderCatalogEntry {
            ...
            name: "BytePlus".into(),
            provider: Provider::Custom,
            default_base_url: "https://ark.ap-southeast.bytepluses.com/api/v3".into(),
            default_model: "dola-seed-2-1-turbo-260628".into(),
            console_url: None,
            key_format: None,
            key_format_hint: None,
            free_tier_note: None,
        ...
        ProviderCatalogEntry {
            ...
            default_model: "gemma-4-31b".into(),
            console_url: None,
            key_format: None,
            key_format_hint: None,
            free_tier_note: None,
        ...
        ProviderCatalogEntry {
            ...
            name: "Chutes".into(),
            provider: Provider::Custom,
            default_base_url: "https://llm.chutes.ai/v1".into(),
            default_model: "zai-org/GLM-5.2-TEE".into(),
            console_url: None,
            key_format: None,
            key_format_hint: None,
            free_tier_note: None,
        ...
        ProviderCatalogEntry {
            ...
            name: "Cohere".into(),
            provider: Provider::Custom,
            default_base_url: "https://api.cohere.ai/compatibility/v1".into(),
            default_model: "command-a-plus-05-2026".into(),
            console_url: None,
            key_format: None,
            key_format_hint: None,
            free_tier_note: None,
        ...
        ProviderCatalogEntry {
            ...
            name: "DeepInfra".into(),
            provider: Provider::Custom,
            default_base_url: "https://api.deepinfra.com/v1/openai".into(),
        ...
        ProviderCatalogEntry {
            ...
            provider: Provider::Custom,
            default_base_url: "https://api.featherless.ai/v1".into(),
            default_model: "Qwen/Qwen3-32B".into(),
            console_url: None,
            key_format: None,
            key_format_hint: None,
            free_tier_note: None,
        ...
        ProviderCatalogEntry {
            ...
            default_model: "accounts/fireworks/routers/glm-5p2-fast".into(),
            console_url: None,
            key_format: None,
            key_format_hint: None,
            free_tier_note: None,
        ...
        ProviderCatalogEntry {
            ...
            name: "GMI Cloud".into(),
            provider: Provider::Custom,
            default_base_url: "https://api.gmi-serving.com/v1".into(),
        ...
        ProviderCatalogEntry {
            ...
            provider: Provider::Custom,
            default_base_url: "https://router.huggingface.co/v1".into(),
            default_model: "deepseek-ai/DeepSeek-R1".into(),
            console_url: None,
            key_format: None,
            key_format_hint: None,
            free_tier_note: None,
        ...
        ProviderCatalogEntry {
            ...
            name: "Kilo Code".into(),
            provider: Provider::Custom,
            default_base_url: "https://api.kilo.ai/api/gateway".into(),
            default_model: "kilo-auto/balanced".into(),
            console_url: None,
            key_format: None,
            key_format_hint: None,
            free_tier_note: None,
        ...
        ProviderCatalogEntry {
            ...
            name: "LongCat".into(),
            provider: Provider::Custom,
            default_base_url: "https://api.longcat.chat/openai".into(),
        ...
        ProviderCatalogEntry {
            ...
            name: "Novita".into(),
            provider: Provider::Custom,
            default_base_url: "https://api.novita.ai/openai/v1".into(),
            default_model: "deepseek/deepseek-v4-pro".into(),
            console_url: None,
            key_format: None,
            key_format_hint: None,
            free_tier_note: None,
        ...
        ProviderCatalogEntry {
            ...
            name: "StepFun".into(),
            provider: Provider::Custom,
            default_base_url: "https://api.stepfun.ai/v1".into(),
        ...
        ProviderCatalogEntry {
            id: "tencent-tokenhub".into(),
            name: "Tencent Hunyuan".into(),
            provider: Provider::Custom,
            default_base_url: "https://tokenhub.tencentmaas.com/v1".into(),
            default_model: "hy4-preview".into(),
            console_url: None,
            key_format: None,
            key_format_hint: None,
            free_tier_note: None,
        ...
        ProviderCatalogEntry {
            ...
            name: "Venice".into(),
            provider: Provider::Custom,
            default_base_url: "https://api.venice.ai/api/v1".into(),
            default_model: "zai-org-glm-4.7".into(),
            console_url: None,
            key_format: None,
            key_format_hint: None,
            free_tier_note: None,
        ...
        ProviderCatalogEntry {
            ...
            default_model: "doubao-seed-evolving".into(),
            console_url: None,
            key_format: None,
            key_format_hint: None,
            free_tier_note: None,
...
/// The base URL for a provider id, from the catalog when it has a row there.
///
/// `Provider::default_base_url()` alone is wrong for every `Custom` row: the
/// enum answers a placeholder for all of them, and Cerebras, Together or xAI
/// would have been called at api.custom.com. Falls back to the enum for ids
/// with no catalog row (a user-defined custom endpoint).
pub fn default_base_url_for(provider_id: &str) -> String {
    provider_catalog()
        .into_iter()
        .find(|e| e.id == provider_id)
        .map(|e| e.default_base_url)
        .unwrap_or_else(|| Provider::from_id(provider_id).default_base_url().to_string())
}
...
mod tests {
    ...
    fn catalog_base_urls_match_enum() {
        for entry in provider_catalog() {
            // A Custom row's URL is its own; the enum has no answer for it.
            if entry.provider == Provider::Custom {
                assert!(entry.default_base_url.starts_with("https://"), "{}", entry.id);
                continue;
            }
            assert_eq!(
