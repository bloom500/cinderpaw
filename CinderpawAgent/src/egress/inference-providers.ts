  ...
  async #stream(
    ...
    try {
      ...
      const processLine = (line: string): void => {
        ...
        // `reasoning_content` is the DeepSeek/NIM/QwQ spelling; `reasoning` is
        // what OpenRouter normalises it to. Reading only the first is why a
        // DeepSeek model behind OpenRouter streamed its reasoning into a void.
