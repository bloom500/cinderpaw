/**
 * Cinderpaw Agent — shared type contracts.
 *
...
export interface InferenceRequest {
   ...
   * to the bundled llama.cpp API (a Cinderpaw extension field) so tool calls are
...
export type OutboundEvent =
  ...
  // Living-organism pulses. Forwarded verbatim over `cinderpaw://agent-output`
  ...
  // over `cinderpaw://agent-output` so the React `events.onDreamCycle` listener can
