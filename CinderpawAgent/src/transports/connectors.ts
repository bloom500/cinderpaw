 ...
 * remedies were restarting Cinderpaw or waiting for the idle eviction window.
 *
 ...
 * All lead with the Cinderpaw paw and stay short — they're a transient status line.
 */
...
export class DiscordConnector {
  ...
  async start(): Promise<void> {
    const client = new Client({
      ...
      // bare client carrying this partial, and neither reached Cinderpaw's.
  ...
  async #onMessage(message: Message): Promise<void> {
    ...
    // Treating that as an empty prompt is what made Cinderpaw answer a bare nudge
    ...
    // Instant acknowledgement: the Cinderpaw paw lands on the message the moment we
