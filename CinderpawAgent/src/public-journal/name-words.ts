/**
 * The BIP-39 English wordlist, minus this journal's own outcome vocabulary.
 *
 * Source: https://raw.githubusercontent.com/bitcoin/bips/master/bip-0039/english.txt
 * SHA-256 of the 2048-line source file:
 *   2f5eed53a4727b4bf8880d8f3f199efc90e58503646d9ff8eff3a2ed3b24dbda
 *
 * Why this list and not one somebody picked: BIP-39's words were selected to a
 * published standard for exactly this job — words a person can read back, say
 * out loud and write down without ambiguity, no two sharing their first four
 * letters. Using it means the vocabulary is not an aesthetic decision anyone
 * has to defend.
 *
 * 17 words are removed, by a rule rather than by taste: a candidate must not be
 * named with a word this journal uses for an OUTCOME. "Layer L1 evaluated
 * Reject at fitness 0.500 and kept the incumbent" reads as a verdict twice and
 * a name never. Removed: best, broken, correct, crash, crime, cruel, danger, dumb, error, good, panic, promote, reject, right, success, win, wrong.
 *
 * 2031 remain. Regenerate by re-fetching the source, checking the hash above,
 * and filtering the same list.
 */
export const NAME_WORDS = [
  ...
  "bench", "benefit", "betray", "better", "between", "beyond", "bicycle", "bid",
  ...
  "bring", "brisk", "broccoli", "bronze", "broom", "brother", "brown", "brush",
  ...
  "equal", "equip", "era", "erase", "erode", "erosion", "erupt", "escape",
  ...
  "goddess", "gold", "goose", "gorilla", "gospel", "gossip", "govern", "gown",
  ...
  "palm", "panda", "panel", "panther", "paper", "parade", "parent", "park",
  ...
  "problem", "process", "produce", "profit", "program", "project", "proof", "property",
  ...
  "region", "regret", "regular", "relax", "release", "relief", "rely", "remain",
  ...
  "rifle", "rigid", "ring", "riot", "ripple", "risk", "ritual", "rival",
  ...
  "style", "subject", "submit", "subway", "such", "sudden", "suffer", "sugar",
  ...
  "wife", "wild", "will", "window", "wine", "wing", "wink", "winner",
  "winter", "wire", "wisdom", "wise", "wish", "witness", "wolf", "woman",
  "wonder", "wood", "wool", "word", "work", "world", "worry", "worth",
  "wrap", "wreck", "wrestle", "wrist", "write", "yard", "year", "yellow",
