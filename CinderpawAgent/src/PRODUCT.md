...
Cinderpaw can add an ability it does not have yet, on request, rather than telling
...
Cinderpaw is built to keep working when nobody is watching — a cron job, or a
