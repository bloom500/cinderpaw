...
/// every divergence between this file and a live Feral build should
/// be intentional and reviewed.
pub const PLAN_MD: &str = r#"# Feral RSI — Fractal Memory System with Recursive Self-Improvement
