...
export const CONFIG_SCHEMA: ConfigEntry[] = [
  ...
  { name: "FERAL_FMS_ALLOW_CLOUD", type: "bool", default: false,
    description: "Explicit opt-in for automatic FMS tree rebuilds to use cloud inference. Cloud remains disabled unless this is true and a positive USD cap is configured.", security: false },
