...
export const CONFIG_SCHEMA: ConfigEntry[] = [
  ...
  { name: "FERAL_WORKSPACE", type: "list", default: null,
    description: "TS sidecar comma/semicolon-separated FS root list. Loader refuses roots that expose ~/.feral (see workspace-roots.ts).", security: true },
  ...
  { name: "FERAL_FETCH_DOMAINS", type: "list", default: null,
    description: "Comma-separated domain allowlist for fetch_url. Empty = tool not registered.", security: true },
  { name: "FERAL_HTTP_DOMAINS", type: "list", default: null,
    description: "Comma-separated domain allowlist for http_request. Empty = tool not registered.", security: true },
