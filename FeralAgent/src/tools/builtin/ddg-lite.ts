/**
 * DuckDuckGo Lite — the keyless search backend Feral ships with.
 *
 ...
 * that still worked, because the limit is per-IP — a second Feral, a browser,
...
export const DDG_THROTTLED_HINT =
  ...
  "couple of minutes. Feral already paces its queries to stay under the limit, " +
