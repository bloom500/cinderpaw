...
export type OutboundEvent =
  ...
  | { type: "rsi_engine_event"; event: "started" | "stopped" | "concurrency_set" | "progress" | "stagnation" | "pbt_sync" | "resumed" | "warning"; id?: string; iteration?: number; bestScore?: number; bestCommit?: string; candidateQueueSize?: number; costSoFarUsd?: number; concurrency?: number; stopReason?: string; reason?: string; killed?: number; creditedId?: string; nextActiveId?: string; replaced?: boolean; genomeId?: string; mutationType?: string; score?: number; tokenCost?: number; durationMs?: number; errored?: boolean; commitHash?: string; previousBest?: number; ratchet?: boolean; cause?: string; died?: boolean; extinction?: boolean; stage?: string; warning?: string; message?: string }
